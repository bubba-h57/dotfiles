...
plugins=(osx aws bubba-brew bubba-exports bubba-aliases bubba-iterm-integration bubba-python command-not-found git git-flow-avh colorize phing python systemd wd zsh-syntax-highlighting)
